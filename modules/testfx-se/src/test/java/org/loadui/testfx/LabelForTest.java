...
public class LabelForTest extends GuiTest
{
	...
	{
		click( Commons.nodeLabeledBy("User name") ).type( "Steve" );
		click( Commons.nodeLabeledBy("Password") ).type( "duke4ever" );

		Assertions.verifyThat("#pword", Commons.hasText("duke4ever"));
	}
}
