...
public class KeyChar {
     ...
     * @param name
     */
    public KeyChar(final char character, final int modifiers,
    ...
    /**
     * Gets modifiers (shift,alt,control) to press to get the right version of
     * the character
     * 
    ...
    /**
     * @return the list of modifiers key codes to maintain pressed to get the
     *         character
     */
    ...
    /**
     * @return the modifiers to maintain pressed to type the character after the
     *         dead key
     */
    ...
    /**
     * @return the list of modifiers key codes to maintain pressed to get the
     *         character, after the dead key (if any)
     */
    ...
    private static KeyCode[] modifiersToKeyCodes(final int modifiers) {
        ...
        if ((modifiers & ALT_GRAPH) != 0) {
            // Due to invalid key code exception when using the ALT_GRAPH key
            // code ...
